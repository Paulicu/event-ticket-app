        ...
        <div class="panel-body">
            ...
            {!! Form::model($ticket, ['method' => 'PATCH','route' => ['tickets.update', $ticket->id]]) !!}
                <div class="form-group">
                    ...
                    <input type="number" name="price" step="0.01" min="0" class="form-control" value="{{ $ticket->price }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="quantity" class="form-control" value="{{ $ticket->quantity }}">
                </div>

                <div class="form-group">
                    <label for="code">Cod</label>
                    <input type="text" name="code" class="form-control" value="{{ $ticket->code }}">
                </div>
